const Form = ({handleSubmit, name, setName, email, setEmail, errorName, errorEmail}) => {
    ...
    return ( 
        ...
        <form onSubmit={ handleSubmit }>
            ...
            <div className="mb-3">
                <label  className="form-label">Email del Colaborador</label>
                <input 
                type="email"
                className="form-control" 
                id="emailColaborador" 
                ...
                />
                {
                errorEmail ? <span style={{color: 'red'}}>Debes Ingresar tu Email</span>  : null
                }
            
            </div>        
            <button type="submit" className="btn btn-light">Agregar Colaborador</button>
        </form>
        </>
    );
}
